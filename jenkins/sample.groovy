pipeline {
    ...
    stages {
        ...
        stage('test') { 
            steps {
                mvn clean verify sonar:sonar   -Dsonar.projectKey=myproject   -Dsonar.host.url=http://34.203.206.247:9000   -Dsonar.login=sqp_60acb5ba14c83cf72deee2902a49e2d0bf75efb1
